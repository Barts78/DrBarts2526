---
title: "Match day 29 Season 2526"
...
#Set Home
Match_Home <- paste0("Wolves")

#set match date
Game_date <- paste("03-03-2026")
...
```{r}
#| height: 100%
#| label: Home Successful EPV Heat Map FT
#| title: Home Successful EPV Heat Map FT
DefEPVHeatMapplotFTS <- DefEPVHeatMapDataFTS %>%
  ...
  #geometrics
  #plot player positions
  geom_point(data = AwayAverage_PlayerFTS, aes(x, y), fill = Color_Away, size = 8, shape = 21, colour = "black", stroke = 0.5, alpha = 0.4) +
  
  #plot heat map
  stat_density_2d(aes(fill = after_stat(level)), geom = "polygon", alpha = 0.4, adjust = 0.5, linewidth = 0.5) +

  # add zone percentage numbers
  geom_text(data = average_DefepvNZFTS, aes(x = x, y = y, label = paste(PEPV, "%")), size = 4) +
    
  #plot player names
  geom_text(data = AwayAverage_PlayerFTS, aes(x, y, label = player_shirt), color = Color_Away_Text, size = 4) +
  ...
  labs(title = paste0(Match_Home," Successful Defensive EPV Heat Map \nFull Game - Open Play"), 
                            subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher EPV Faced, Box figures = % of Total Defensive EPV \nDirection of Attack Right to Left"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
        panel.background = element_rect(colour = "snow", fill = "snow"),
...
```{r}
#| height: 100%
#| label: Home Unsuccessful EPV Heat Map FT
#| title: Home Unsuccessful EPV Heat Map FT
DefEPVHeatMapplotFTU <- DefEPVHeatMapDataFTU %>%
  ...
  #geometrics
  #plot player positions
  geom_point(data = AwayAverage_PlayerFTU, aes(x, y), fill = Color_Away, size = 8, shape = 21, colour = "black", stroke = 0.5, alpha = 0.4) +
  
  #plot heat map
  stat_density_2d(aes(fill = after_stat(level)), geom = "polygon", alpha = 0.4, adjust = 0.5, linewidth = 0.5) +

  # add zone percentage numbers
  geom_text(data = average_DefepvNZFTU, aes(x = x, y = y, label = paste(PEPV, "%")), size = 4) +
    
  #plot player names
  geom_text(data = AwayAverage_PlayerFTU, aes(x, y, label = player_shirt), color = Color_Away_Text, size = 4) +
...
```{r}
#| height: 100%
#| label: Away Successful EPV Heat Map FT
#| title: Away Successful EPV Heat Map FT
...
AwayDefEPVHeatMapplotFTS <- AwayDefEPVHeatMapDataFTS %>%
  ...
  #geometrics
  #plot player positions
  geom_point(data = Average_PlayerFTS, aes(x, y), fill = Color_Home, size = 8, shape = 21, colour = "black", stroke = 0.5, alpha = 0.4) +
  
   #plot player names
  geom_text(data = Average_PlayerFTS, aes(x, y, label = player_shirt), color = Color_Home_Text, size = 4) +
  ...
  # add zone percentage numbers
  geom_text(data = Awayaverage_DefepvNZFTS, aes(x = x, y = y, label = paste(PEPV, "%")), size = 4) +
...
```{r}
#| height: 100%
#| label: Away Unsuccessful EPV Heat Map FT
#| title: Away Unsuccessful EPV Heat Map FT
...
AwayDefEPVHeatMapplotFTU <- AwayDefEPVHeatMapDataFTU %>%
  ...
  #geometrics
  #plot player positions
  geom_point(data = Average_PlayerFTU, aes(x, y), fill = Color_Home, size = 8, shape = 21, colour = "black", stroke = 0.5, alpha = 0.4) +
  
  #plot player names
  geom_text(data = Average_PlayerFTU, aes(x, y, label = player_shirt), color = Color_Home_Text, size = 4) +
  
  #plot heat map
  #stat_density_2d(  data = AwayEvents_FTU_w, aes(x = x, y = y, fill = after_stat(level)), geom = "polygon", alpha = 0.35, bins = 8, n = 300, adjust = 0.8, linewidth = 0, colour = NA) +
  ...
  # add zone percentage numbers
  geom_text(data = Awayaverage_DefepvNZFTU, aes(x = x, y = y, label = paste(PEPV, "%")), size = 4) +
...
### column {.tabset}
```{r}
#| title: home Defensive actions to 1st Sub
...
```{r}
#| height: 100%
#| title: home Defensive actions Post 1st Sub
#| label: home Defensive actions Post 1st Sub
...
```{r}
#| height: 100%
#| title: Away Defensive actions to 1st Sub
...
```{r}
#| height: 100%
#| title: Away Defensive actions Post 1st Sub
...
### column {.tabset}
```{r}
#| title: Home Defensive actions 1st Half
...
```{r}
#| title: Home Defensive actions 2nd Half
...
### column {.tabset}
```{r}
#| title: Away Defensive actions 1st Half
...
```{r}
#| title: Away Defensive actions 2nd Half
