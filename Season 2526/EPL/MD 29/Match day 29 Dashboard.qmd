...
#| title: Unsuccessful EPV + Events Heat Map
#| fig-width: 5.2
#| fig-height: 4
#| fig-dpi: 150
...
AwayDefEPVHeatMapplotFTS <- AwayDefEPVHeatMapDataFTS %>%
  ...
  stat_density_2d(  #data = AwayEvents_FTS_w, 
    aes(x = x, y = y, fill = after_stat(level)), geom = "polygon", alpha = 0.35, bins = 8, n = 300, adjust = 0.8, linewidth = 0, colour = NA) +
