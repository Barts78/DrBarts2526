...
#Set Home
Match_Home <- paste0("Sunderland")

#set match date
Game_date <- paste("11-02-2026")
...
ColorScale_HomeC <- build_palette(homeplayers, Color_Home, "white", "C")

ColorScale_Home <- build_palette(homeplayers, Color_Home,  "white", "D")

ColorScale_AwayC <- build_palette(awayplayers, Color_Away,  "white", "C")

ColorScale_Away <- build_palette(awayplayers, Color_Away,  "white", "D")
