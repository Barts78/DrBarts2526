---
title: "CL Match day R16 L1 Season 2526"
...
#Set Home
Match_Home <- paste0("Galatasaray")

#set match date
Game_date <- paste("10-03-2026")
...
#set database
DataBaseName <- paste0("CL_LFC_Games_2526")

######################
#set colours
#set Home color
Color_Home <- paste("orange")

#set home text color
Color_Home_Text <- paste("white")

#set Away color
Color_Away <- paste("#008B00")
...
#load match data
fileName <- paste0("~/Documents/Dropbox files/AI LFC data/Data Sets/WhoScored/Season 2526/CL Games/Processed Games/", Match_Fixture, ".xlsx")
plottingData <- read_xlsx(fileName)

#load player data
PlayerfileName <- paste0("~/Documents/Dropbox files/AI lfc data/Data Sets/WhoScored/Season 2526/CL Players/Processed Games/", Match_Fixture, " - PlayerData.xlsx")
...
Vizlocation <- paste0("~/Documents/Dropbox files/AI LFC data/R files/AI UP/Scripts/Viz Pack/Season 2526/CL/", GameWeek)
#####################################
...
social_caption <- function(twitter="@Barts78",
  ...
  for (name in names(social)) {
    ...
    html = glue("<span style='font-family:\"Font Awesome 7 Brands\";color:{icon_color};font-size:8px;'>{icon};</span>
                ...
                <span style='font-family:{font_family};color:{font_color};font-size:7px;'>{info}</span>
                <span style='color:{bg_color};font-size:7px;'>.</span>")
...
my_datasource <- paste0('<span style="font-family:\'Font Awesome 7 Free\', Arial, sans-serif;color:#454545;font-size:7px;">&#x1F4BE;</span>',
                        '<span style="color:#FFF9FB;font-size:7px;">...</span>',
                        '<span style="font-family:sans-serif;color:#454545;font-size:7px;">OPTA</span>',
                        '<span style="color:#FFF9FB;font-size:7px;">...</span>')
...
MD_MC_Plot <- ggplot(long_prob_matrix, aes(x = as.numeric(Home), y = as.numeric(Away), fill = Probability)) +
  ...
  geom_text(aes(label = paste(Probability, "%")), size = 3, color = if_else(long_prob_matrix$Probability > 4.5, Color_Home_Text, Color_Away_Text),) +
        scale_fill_gradientn(
...
MD_MC_Plot <- ggplot(long_prob_matrix_blend, aes(x = as.numeric(Home), y = as.numeric(Away), fill = Probability)) +
  geom_tile(colour = "black") +
  geom_text(aes(label = paste(Probability, "%")), size = 3, color = if_else(long_prob_matrix_blend$Probability > 4.5, Color_Home_Text, Color_Away_Text),) +
        scale_fill_gradientn(
        colors = c(Color_Away, Color_Home),
        values = scales::rescale(c(0, 1)), 
        name = "Probablity") +
...
MD_MC_Plot <- ggplot(long_prob_matrix_max, aes(x = as.numeric(Home), y = as.numeric(Away), fill = Probability)) +
  geom_tile(colour = "black") +
  geom_text(aes(label = paste(Probability, "%")), size = 3, color = if_else(long_prob_matrix_max$Probability > 4.5, Color_Home_Text, Color_Away_Text),) +
        scale_fill_gradientn(
        colors = c(Color_Away, Color_Home),
        values = scales::rescale(c(0, 1)), 
        name = "Probablity") +
...
MD_MC_Plot <- ggplot(long_prob_matrix_min, aes(x = as.numeric(Home), y = as.numeric(Away), fill = Probability)) +
  geom_tile(colour = "black") +
  geom_text(aes(label = paste(Probability, "%")), size = 3, color = if_else(long_prob_matrix_min$Probability > 4.5, Color_Home_Text, Color_Away_Text),) +
        scale_fill_gradientn(
        colors = c(Color_Away, Color_Home),
        values = scales::rescale(c(0, 1)), 
        name = "Probablity") +
...
MD_MC_Result_Plot <- ggplot(outcome_prob) +
  ...
  scale_fill_identity(name = "",
                      ...
                      guide = "legend") +
  geom_text(aes(x = Outcome, y = Probability, label = paste(Probability, " %")), size = 3, vjust = -0.5,colour = "black") + 
