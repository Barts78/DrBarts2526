---
title: "FAC Match day 5 Season 2526"
...
Vizlocation <- paste0("~/Documents/Dropbox files/AI LFC data/R files/AI UP/Scripts/Viz Pack/Season 2526/FAC/", GameWeek)
#####################################
...
MD_MC_Plot <- ggplot(long_prob_matrix_blend, aes(x = as.numeric(Home), y = as.numeric(Away), fill = Probability)) +
  geom_tile(colour = "black") +
  geom_text(aes(label = paste(Probability, "%")), size = 4, color = if_else(long_prob_matrix_blend$Probability > 4.5, Color_Home_Text, Color_Away_Text),) +
        scale_fill_gradientn(
        colors = c(Color_Away, Color_Home),
        values = scales::rescale(c(0, 1)), 
        name = "Probablity") +
...
MD_MC_Plot <- ggplot(long_prob_matrix_max, aes(x = as.numeric(Home), y = as.numeric(Away), fill = Probability)) +
  geom_tile(colour = "black") +
  geom_text(aes(label = paste(Probability, "%")), size = 4, color = if_else(long_prob_matrix_max$Probability > 4.5, Color_Home_Text, Color_Away_Text),) +
        scale_fill_gradientn(
        colors = c(Color_Away, Color_Home),
        values = scales::rescale(c(0, 1)), 
        name = "Probablity") +
...
MD_MC_Plot <- ggplot(long_prob_matrix_min, aes(x = as.numeric(Home), y = as.numeric(Away), fill = Probability)) +
  geom_tile(colour = "black") +
  geom_text(aes(label = paste(Probability, "%")), size = 4, color = if_else(long_prob_matrix_min$Probability > 4.5, Color_Home_Text, Color_Away_Text),) +
        scale_fill_gradientn(
        colors = c(Color_Away, Color_Home),
        values = scales::rescale(c(0, 1)), 
        name = "Probablity") +
...
#| title: Match Result Probablity xG
